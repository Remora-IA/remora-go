...
- **paladin/pingpong_eval.go**: archivo nuevo
- **paladin/pingpong_eval_test.go**: archivo nuevo

### Flujo

- **static/index.html**: +4 / -2
- **api_rest/business_artifacts.go**: funciones: resolveBusinessSQLitePath, resolveRuntimeBusinessDBPath, resolveBusinessSemanticPackPath, (s *server) businessSQLitePath
- **api_rest/drivers.go**: +1 / -1
- **api_rest/flow_artifacts.go**: funciones: (s *server) allFlowArtifactPaths | tipos: artifactPath
- **api_rest/flow_run_types.go**: +2
- **api_rest/generic_driver.go**: funciones: newGenericDriver
- **api_rest/main.go**: +3 / -4
- **api_rest/orchestrator.go**: funciones: (s *server) executeSessionFollowupDetailed, (s *server) persistFollowupArtifact, sortedKeysInterfaceMap, resolveDelegationExecutionTarget | tipos: sessionFollowupExecution
- **api_rest/simulation_autonomia.go**: archivo nuevo
- **autonomia/session.go**: archivo nuevo
- **api_rest/flow_dimensions.go**: funciones: deepAnalysisSimulatedConversation, simulatedDeepAnalysisContinuePrompts, deepAnalysisStressTurnLimit, simulatedDelegationPlanStep
- **api_rest/flow_execution.go**: funciones: (s *server) materializePortableArtifactParam
- **api_rest/business_artifacts_test.go**: funciones: TestRuntimeBusinessDBPathFallsBackToLegacyLocationWhenNoResolvedSQLiteExists
- **api_rest/flow_run_test.go**: funciones: interfaceSliceToStrings
- **api_rest/remora_cli_real_conversation_test.go**: archivo nuevo
- **api_rest/session_engine_test.go**: funciones: TestNormalizeFollowupDelegationRequestsSimilarCustomers, TestNormalizeFollowupDelegationRequestsCaseDetails, TestNormalizeFollowupDelegationRequestsCompletesInsufficientPortfolioPlan, TestNormalizeFollowupDelegationRequestsPreservesValidPortfolioCapabilityWithNonCanonicalFramework
- **api_rest/simulation_autonomia_test.go**: archivo nuevo
- **autonomia/session_test.go**: archivo nuevo

### Repo

- **api-actor**: nueva API para declarar Actor (quien actúa) (framework-paladin/README.md, framework-paladin/README.md)
- **api-goal**: nueva API para declarar Goal (intención del span) (framework-paladin/SYSTEM.md, examples/README.md, framework-paladin/SYSTEM.md, examples/README.md, 03_semantic_flow/main.go, 03_semantic_flow/main.go)
- **paladin-server**: servidor HTTP para recibir traces (server/main.go, server/main.go)
- **cola-preguntas**: sistema de cola de preguntas para control de turnos (handoff/questions_queue.go, handoff/questions_queue.go)
- **quine-taxonomia-comandos**: taxonomia semantica de comandos (types/types.go, types/types.go)
- **quine-checklist-comandos**: checklist para verificar comandos ejecutables (framework-quine/INITIAL_PROMPT.md, framework-quine/INITIAL_PROMPT.md, review/review.go, review/review.go)
- **flujo-terminal-handoff**: terminal handoff para comandos done/ask-echo (nativeagent/agent.go, nativeagent/agent.go)
- **main-multi-modo**: main.go soporta multiples modos (audit, explain, tree) (frameworkauditor/main.go, frameworkmecanico/main.go, frameworkmensajero/main.go, frameworkradar/main.go, frameworksabio/main.go, remora/main.go, frameworkradar/main.go, frameworkauditor/main.go, frameworkmecanico/main.go, frameworkmensajero/main.go, frameworkradar/main.go, frameworksabio/main.go, remora/main.go)
- **quizzical-murdock-aa8156/.env**: archivo nuevo
- **quizzical-murdock-aa8156/.env.example**: archivo nuevo
- **quizzical-murdock-aa8156/.git**: archivo nuevo
- **quizzical-murdock-aa8156/.gitignore**: archivo nuevo
- **quizzical-murdock-aa8156/CHANGELOG.md**: archivo nuevo
- **quizzical-murdock-aa8156/Makefile**: archivo nuevo
- **quizzical-murdock-aa8156/PROMPT_PROBLEMAS_RONDA2**: archivo nuevo
- **channel/Dockerfile**: archivo nuevo
- **channel/go.mod**: archivo nuevo
- **quizzical-murdock-aa8156/cloudbuild-ci.yaml**: archivo nuevo
- **quizzical-murdock-aa8156/cloudbuild.yaml**: archivo nuevo
- **quizzical-murdock-aa8156/docker-compose.yml**: archivo nuevo
- **framework-alfa/.gitignore**: archivo nuevo
- **framework-alfa/framework.manifest.json**: archivo nuevo
- **framework-alfa/go.mod**: archivo nuevo
...
- **prospectos-seguimiento/go.mod**: archivo nuevo
- **prospectos-seguimiento/vista-prospectos**: archivo nuevo
- **framework-bravo/framework.manifest.json**: archivo nuevo
- **framework-bravo/go.mod**: archivo nuevo
- **framework-charlie/.charlieignore**: archivo nuevo
- **framework-charlie/framework.manifest.json**: archivo nuevo
- **framework-charlie/go.mod**: archivo nuevo
...
- **framework-echo/.gitignore**: archivo nuevo
- **framework-echo/framework.manifest.json**: archivo nuevo
- **framework-echo/go.mod**: archivo nuevo
- **framework-excel/Makefile**: archivo nuevo
- **framework-excel/framework.manifest.json**: archivo nuevo
- **framework-excel/go.mod**: archivo nuevo
- **framework-excel/go.sum**: archivo nuevo
...
- **framework-foco/go.sum**: archivo nuevo
- **framework-foco/register_all.sh**: archivo nuevo
- **framework-foco/register_axiomas.sh**: archivo nuevo
- **framework-gmail/Makefile**: archivo nuevo
- **framework-gmail/framework.manifest.json**: archivo nuevo
- **framework-gmail/go.mod**: archivo nuevo
- **framework-hosting/framework.manifest.json**: archivo nuevo
- **framework-hosting/frameworkhosting**: archivo nuevo
- **framework-hosting/go.mod**: archivo nuevo
- **framework-indexa/.env.example**: archivo nuevo
- **framework-indexa/cron-sync.sh**: archivo nuevo
...
- **framework-indexa/sync.sh**: archivo nuevo
...
- **framework-mensajero/framework.manifest.json**: archivo nuevo
- **framework-mensajero/frameworkmensajero**: archivo nuevo
- **framework-mensajero/go.mod**: archivo nuevo
- **framework-paladin/framework.manifest.json**: archivo nuevo
- **framework-paladin/frameworkpaladin**: archivo nuevo
- **framework-paladin/go.mod**: archivo nuevo
...
- **framework-quine/frameworks.json**: archivo nuevo
- **framework-quine/go.mod**: archivo nuevo
- **framework-radar/framework.manifest.json**: archivo nuevo
- **framework-radar/frameworkradar**: archivo nuevo
- **framework-radar/go.mod**: archivo nuevo
- **framework-radar/go.sum**: archivo nuevo
- **biz_-vvG6gwJyVXqvXgX/sabio.business.json**: archivo nuevo
- **biz_28wRw-nkuUClBWwG/sabio.business.json**: archivo nuevo
- **biz_vh9T64yrCmdnR5Xf/sabio.business.json**: archivo nuevo
...
- **framework-tareas/framework.manifest.json**: archivo nuevo
- **framework-tareas/frameworktareas**: archivo nuevo
- **framework-tareas/go.mod**: archivo nuevo
- **framework-tareas/go.sum**: archivo nuevo
- **cobranza-chile/contacts.seed.csv**: archivo nuevo
- **cobranza-chile/flow.rules.json**: archivo nuevo
- **cobranza-chile/profile.json**: archivo nuevo
- **cobranza-chile/tasks.seed.json**: archivo nuevo
...
- **remora-flujo/.gitignore**: archivo nuevo
- **remora-flujo/.remora_session**: archivo nuevo
- **remora-flujo/framework_session**: archivo nuevo
- **frontend-chat/index.html**: archivo nuevo
- **frontend-chat/serve.sh**: archivo nuevo
- **remora-flujo/go.mod**: archivo nuevo
- **remora-flujo/go.sum**: archivo nuevo
...
- **.remora_session**: archivo nuevo
- **data/findings.json**: +1 / -1
- **framework-pingpong/framework.manifest.json**: +6 / -1
- **framework-radar/framework.manifest.json**: +4
- **framework-sabio/framework.manifest.json**: +27 / -3
- **remora-cli/remora**: configuracion
- **sessions/conv_1777588675507545000.jsonl**: -4
- **sessions/conv_1777590457233338000.jsonl**: -4
- **sessions/conv_1777590556636254000.jsonl**: -7
- **sessions/conv_1777590615947918000.jsonl**: -4
- **sessions/conv_1777590961468041000.jsonl**: -4
- **sessions/conv_1777591066591723000.jsonl**: -10
- **sessions/conv_1777591126226500000.jsonl**: -10
- **sessions/conv_1777591289579492000.jsonl**: -4
- **sessions/conv_1777596871412664000.jsonl**: -10
- **sessions/conv_1777596933569136000.jsonl**: -1
- **sessions/conv_1777596938610675000.jsonl**: -16
- **sessions/conv_1777597083632122000.jsonl**: -5
- **autonomia-e2e/01-arranque.png**: archivo nuevo
- **autonomia-e2e/02-hola.png**: archivo nuevo
- **autonomia-e2e/03-como-estas.png**: archivo nuevo
- **autonomia-e2e/03-universo.png**: archivo nuevo
- **autonomia-e2e/04-patrones-generales.png**: archivo nuevo
- **autonomia-e2e/04-repair-que.png**: archivo nuevo
- **autonomia-e2e/05-foco-drilldown.png**: archivo nuevo
- **autonomia-e2e/05-universo.png**: archivo nuevo
- **autonomia-e2e/06-abrir-case.png**: archivo nuevo
- **autonomia-e2e/06-patrones-generales.png**: archivo nuevo
- **autonomia-e2e/06-priorizacion-operativa.png**: archivo nuevo
- **autonomia-e2e/07-abrir-case.png**: archivo nuevo
- **autonomia-e2e/07-evidencia-accion.png**: archivo nuevo
- **autonomia-e2e/07-foco-drilldown.png**: archivo nuevo
- **autonomia-e2e/08-evidencia-accion.png**: archivo nuevo
- **autonomia-e2e/08-priorizacion-operativa.png**: archivo nuevo
- **autonomia-e2e/08-volver-general.png**: archivo nuevo
- **autonomia-e2e/09-abrir-case.png**: archivo nuevo
- **autonomia-e2e/09-forecast-bloqueado.png**: archivo nuevo
- **autonomia-e2e/09-volver-general.png**: archivo nuevo
- **autonomia-e2e/10-evidencia-accion.png**: archivo nuevo
- **autonomia-e2e/10-forecast-bloqueado.png**: archivo nuevo
- **autonomia-e2e/11-volver-general.png**: archivo nuevo
- **autonomia-e2e/12-forecast-bloqueado.png**: archivo nuevo
- **autonomia-e2e/failure.png**: archivo nuevo
- **sharp-wozniak-03b9d5/.env.example**: archivo nuevo
- **sharp-wozniak-03b9d5/.git**: archivo nuevo
- **sharp-wozniak-03b9d5/.gitignore**: archivo nuevo
- **sharp-wozniak-03b9d5/CHANGELOG.md**: archivo nuevo
- **sharp-wozniak-03b9d5/Makefile**: archivo nuevo
- **sharp-wozniak-03b9d5/PROMPT_PROBLEMAS_RONDA2**: archivo nuevo
- **channel/Dockerfile**: archivo nuevo
- **channel/go.mod**: archivo nuevo
- **sharp-wozniak-03b9d5/cloudbuild-ci.yaml**: archivo nuevo
- **sharp-wozniak-03b9d5/cloudbuild.yaml**: archivo nuevo
- **sharp-wozniak-03b9d5/docker-compose.yml**: archivo nuevo
- **framework-alfa/.gitignore**: archivo nuevo
- **framework-alfa/framework.manifest.json**: archivo nuevo
- **framework-alfa/go.mod**: archivo nuevo
- **framework-arquitecto/framework.manifest.json**: archivo nuevo
...
- **tmp/channel.pid**: archivo nuevo
- **tmp/flujo_api.pid**: archivo nuevo
- **simulacion/Makefile**: archivo nuevo
- **simulacion/autonomia-controlada**: archivo nuevo
- **simulacion/autonomia-controlada.html**: +382 / -256
- **simulacion/go.mod**: archivo nuevo
- **simulacion/go.sum**: archivo nuevo
- **simulacion/panalbit.sqlite**: archivo nuevo
- **.claude/CLAUDE.md**: archivo nuevo
- **.codex/instructions.md**: archivo nuevo
- **quizzical-murdock-aa8156/AGENTS.md**: archivo nuevo
- **quizzical-murdock-aa8156/ARCHITECTURE.md**: archivo nuevo
- **quizzical-murdock-aa8156/COMMIT_GUIDE.md**: archivo nuevo
- **quizzical-murdock-aa8156/HANDOFF_PROMPT.md**: archivo nuevo
- **quizzical-murdock-aa8156/PROMPT_PROBLEMAS_DETECTADOS.md**: archivo nuevo
- **quizzical-murdock-aa8156/PROMPT_PROBLEMAS_RONDA2.md**: archivo nuevo
- **quizzical-murdock-aa8156/PROMPT_VISION_COMPLETA.md**: archivo nuevo
- **quizzical-murdock-aa8156/README.md**: archivo nuevo
- **quizzical-murdock-aa8156/SKILL_COLABORACION.md**: archivo nuevo
- **channel/AXIOMS.md**: archivo nuevo
- **channel/README.md**: archivo nuevo
- **docs/AXIOMS.md**: archivo nuevo
- **docs/CAPABILITIES.md**: archivo nuevo
- **framework-alfa/AGENTS.md**: archivo nuevo
- **framework-alfa/INITIAL_PROMPT.md**: archivo nuevo
- **framework-alfa/README.md**: archivo nuevo
...
- **framework-bravo/INITIAL_PROMPT.md**: archivo nuevo
- **framework-bravo/README.md**: archivo nuevo
- **framework-bravo/WHY.md**: archivo nuevo
- **prompts/SYSTEM_PROMPT.md**: archivo nuevo
- **prompts/VERIFICATION_PROMPT.md**: archivo nuevo
- **framework-charlie/AGENTS.md**: archivo nuevo
- **framework-charlie/INITIAL_PROMPT.md**: archivo nuevo
- **framework-charlie/README.md**: archivo nuevo
...
- **framework-echo/AGENTS.md**: archivo nuevo
- **framework-echo/INITIAL_PROMPT.md**: archivo nuevo
- **framework-echo/README.md**: archivo nuevo
- **framework-echo/WHY.md**: archivo nuevo
- **docs/EVALUADOR_FRAMEWORKECHO.md**: archivo nuevo
- **docs/FRAMEWORKECHO_EXPLICACION_COMPLETA.md**: archivo nuevo
- **docs/SYSTEM_PROMPT.md**: archivo nuevo
- **framework-excel/AGENTS.md**: archivo nuevo
- **framework-excel/INITIAL_PROMPT.md**: archivo nuevo
- **framework-excel/README.md**: archivo nuevo
- **framework-excel/WHY.md**: archivo nuevo
- **framework-foco/AGENTS.md**: archivo nuevo
- **framework-foco/INITIAL_PROMPT.md**: archivo nuevo
- **framework-foco/PROPUESTA_PRIORIZACION.md**: archivo nuevo
- **framework-foco/README.md**: archivo nuevo
- **framework-foco/WHY.md**: archivo nuevo
- **framework-gmail/AGENTS.md**: archivo nuevo
- **framework-gmail/INITIAL_PROMPT.md**: archivo nuevo
- **framework-gmail/README.md**: archivo nuevo
...
- **framework-paladin/INITIAL_PROMPT.md**: archivo nuevo
- **framework-paladin/WHY.md**: archivo nuevo
- **docs/MERE.md**: archivo nuevo
...
- **framework-quine/AGENTS.md**: archivo nuevo
- **framework-quine/WHY.md**: archivo nuevo
- **framework-radar/WHY.md**: archivo nuevo
...
- **quizzical-murdock-aa8156/nuevo_mapa.md**: archivo nuevo
...
- **templates/README.md**: archivo nuevo
- **templates/carta_requerimiento.md**: archivo nuevo
- **templates/email_recordatorio.md**: archivo nuevo
- **templates/email_requerimiento_formal.md**: archivo nuevo
- **remora-flujo/README.md**: archivo nuevo
- **.claude/CLAUDE.md**: archivo nuevo
- **.codex/instructions.md**: archivo nuevo
- **sharp-wozniak-03b9d5/AGENTS.md**: archivo nuevo
- **sharp-wozniak-03b9d5/ARCHITECTURE.md**: archivo nuevo
- **sharp-wozniak-03b9d5/COMMIT_GUIDE.md**: archivo nuevo
- **sharp-wozniak-03b9d5/HANDOFF_PROMPT.md**: archivo nuevo
- **sharp-wozniak-03b9d5/PROMPT_PROBLEMAS_DETECTADOS.md**: archivo nuevo
- **sharp-wozniak-03b9d5/PROMPT_PROBLEMAS_RONDA2.md**: archivo nuevo
- **sharp-wozniak-03b9d5/PROMPT_VISION_COMPLETA.md**: archivo nuevo
- **sharp-wozniak-03b9d5/README.md**: archivo nuevo
- **sharp-wozniak-03b9d5/SKILL_COLABORACION.md**: archivo nuevo
- **channel/AXIOMS.md**: archivo nuevo
- **channel/README.md**: archivo nuevo
- **docs/AXIOMS.md**: archivo nuevo
- **docs/CAPABILITIES.md**: archivo nuevo
...
- **framework-tareas/INITIAL_PROMPT.md**: archivo nuevo
- **framework-tareas/WHY.md**: archivo nuevo
- **sharp-wozniak-03b9d5/nuevo_mapa.md**: archivo nuevo
- **cobranza-chile/foco.md**: archivo nuevo
- **cobranza-chile/glossary.md**: archivo nuevo
- **cobranza-chile/mecanico.md**: archivo nuevo
- **cobranza-chile/sabio.md**: archivo nuevo
...
- **templates/email_requerimiento_formal.md**: archivo nuevo
- **remora-flujo/README.md**: archivo nuevo
- **adapter/adapter.go**: archivo nuevo
- **alfa-runner/main.go**: archivo nuevo
- **channel/main.go**: archivo nuevo
- **echo-runner/main.go**: archivo nuevo
- **credentials/smtp.go**: archivo nuevo
- **internal/handler.go**: archivo nuevo
- **internal/jsonrpc.go**: archivo nuevo
- **internal/response.go**: archivo nuevo
- **internal/security.go**: archivo nuevo
- **internal/session.go**: archivo nuevo
- **manifest/manifest.go**: archivo nuevo
- **profile/profile.go**: archivo nuevo
- **alfa/compile.go**: archivo nuevo
- **alfa/types.go**: archivo nuevo
...
- **llm/client.go**: archivo nuevo
- **bravo/idealflow.go**: archivo nuevo
- **bravo/trace.go**: archivo nuevo
- **bravo/verifier.go**: archivo nuevo
- **ecommerce-pedidos/main.go**: archivo nuevo
- **prospectos-seguimiento/main.go**: archivo nuevo
- **llm/client.go**: archivo nuevo
- **llm/client.go**: archivo nuevo
...
- **llm/client.go**: archivo nuevo
- **frameworkecho/main.go**: archivo nuevo
- **llm/client.go**: archivo nuevo
- **tree/node.go**: archivo nuevo
- **tree/readiness.go**: archivo nuevo
- **tree/tree.go**: archivo nuevo
- **framework-excel/client.go**: archivo nuevo
- **framework-excel/types.go**: archivo nuevo
- **llm/client.go**: archivo nuevo
- **foco/cobranza_sql.go**: archivo nuevo
- **foco/cobranza_tasks.go**: archivo nuevo
- **foco/main.go**: archivo nuevo
- **llm/client.go**: archivo nuevo
- **framework-gmail/client.go**: archivo nuevo
- **framework-gmail/types.go**: archivo nuevo
- **llm/client.go**: archivo nuevo
- **frameworkhosting/main.go**: archivo nuevo
- **cpanel/client.go**: archivo nuevo
- **cpanel/domain.go**: archivo nuevo
- **cpanel/email.go**: archivo nuevo
- **cpanel/mailbox.go**: archivo nuevo
...
- **llm/client.go**: archivo nuevo
- **llm/client.go**: archivo nuevo
- **01_basic/main.go**: archivo nuevo
- **02_decisions/main.go**: archivo nuevo
- **llm/client.go**: archivo nuevo
...
- **frameworktareas/main.go**: archivo nuevo
- **llm/client.go**: archivo nuevo
- **agentrpc/main.go**: archivo nuevo
- **framework_session/main.go**: archivo nuevo
- **llm/client.go**: archivo nuevo
- **nativeagent/types.go**: archivo nuevo
- **framework-pingpong/main.go**: funciones: cmdReview
- **pingpong/flow80.go**: funciones: (c *Client) Review
- **pingpong/verifier.go**: funciones: checkCommandForFile, hasGoModInTree
- **frameworksabio/main.go**: funciones: runEntity360Artifact, entity360ErrorArtifact, runAnalyticalQueryArtifact, canonicalAnalyticalIntent | tipos: portfolioRow
- **remora/main.go**: funciones: runSingleTurn, parseFrameworks, saveSessionState, currentSessionKind
- **adapter/adapter.go**: archivo nuevo
- **alfa-runner/main.go**: archivo nuevo
- **channel/main.go**: archivo nuevo
- **echo-runner/main.go**: archivo nuevo
...
- **llm/client.go**: archivo nuevo
- **nativeagent/types.go**: archivo nuevo
- **simulacion/main.go**: archivo nuevo
- **simulacion/portfolio.go**: archivo nuevo
- **orchestrator/main.go**: archivo nuevo
- **vault/main.go**: archivo nuevo
- **internal/exec.go**: archivo nuevo
- **internal/logging.go**: archivo nuevo
- **internal/whitelist.go**: archivo nuevo
- **vault/vault.go**: archivo nuevo
- **frameworkalfa/automation.go**: archivo nuevo
- **frameworkalfa/main.go**: archivo nuevo
- **alfa/bravo.go**: archivo nuevo
- **checks/sqlite.go**: archivo nuevo
- **deployer/main.go**: archivo nuevo
- **deployer/deploy.go**: archivo nuevo
- **framework-echo/main.go**: archivo nuevo
- **frameworkecho/automation.go**: archivo nuevo
- **tree/questions.go**: archivo nuevo
- **framework-excel/main.go**: archivo nuevo
- **framework-gmail/main.go**: archivo nuevo
- **framework-pingpong/palindrome.go**: archivo nuevo
...
- **llmtest/main.go**: archivo nuevo
- **frontends/serve.go**: archivo nuevo
- **orchestrator/main.go**: archivo nuevo
- **vault/main.go**: archivo nuevo
- **internal/exec.go**: archivo nuevo
- **internal/logging.go**: archivo nuevo
...
- **frameworkradar/main_test.go**: archivo nuevo
- **frameworksabio/main_test.go**: archivo nuevo
- **framework-sabio/qa_fixture_test.go**: archivo nuevo
- **nativeagent/agent_test.go**: archivo nuevo
- **framework-pingpong/review_integration_test.go**: archivo nuevo
- **pingpong/flow80_test.go**: +2 / -2
- **pingpong/review_test.go**: archivo nuevo
- **frameworkradar/main_test.go**: funciones: TestBuildFollowupResponseIntegratesStructuredEvidenceAndFailure, TestSummarizePortfolioEvidenceUsesStructuredMetricsAndPeers, TestBuildEvidenceCentricFollowupSynthesisUsesVerifiedPortfolioEvidenceFirst, TestRunAnalyzeFollowupPrefersEvidenceFirstSynthesisOverGenericLLMDraft
- **frameworksabio/main_test.go**: funciones: TestRunEntity360ArtifactBuildsStructuredCustomerView, TestSabioQueryArtifactExposesPlainTextAndTrace, TestRunAnalyticalQueryArtifactPortfolioComparison, TestRunAnalyticalQueryArtifactPortfolioComparisonFromFreeTextIntentAndSemanticCapability
- **manifest/manifest_test.go**: archivo nuevo
- **alfa/compile_test.go**: archivo nuevo
- **checks/sqlite_test.go**: archivo nuevo
- **frameworkauditor/main_test.go**: archivo nuevo
...
- **framework-sabio/qa_fixture_test.go**: archivo nuevo
- **nativeagent/agent_test.go**: archivo nuevo
- **simulacion/portfolio_test.go**: archivo nuevo
- **evento-echo-user-answered**: nuevo evento echo-user-answered (handoff/state.go, handoff/state.go)
### Charlie

- **framework-charlie/.charlieignore**: +4
- **paladin/pingpong_eval.go**: archivo nuevo
- **paladin/pingpong_eval_test.go**: archivo nuevo
- **static/index.html**: +4 / -2
- **api_rest/business_artifacts.go**: funciones: resolveBusinessSQLitePath, resolveRuntimeBusinessDBPath, resolveBusinessSemanticPackPath, (s *server) businessSQLitePath
...
- **api_rest/simulation_autonomia_test.go**: archivo nuevo
- **autonomia/session_test.go**: archivo nuevo
- **api-actor**: nueva API para declarar Actor (quien actúa) (framework-paladin/README.md)
- **api-goal**: nueva API para declarar Goal (intención del span) (framework-paladin/SYSTEM.md, examples/README.md, 03_semantic_flow/main.go)
...
- **quine-taxonomia-comandos**: taxonomia semantica de comandos (types/types.go)
- **quine-checklist-comandos**: checklist para verificar comandos ejecutables (framework-quine/INITIAL_PROMPT.md, review/review.go)
- **flujo-terminal-handoff**: terminal handoff para comandos done/ask-echo (nativeagent/agent.go)
- **main-multi-modo**: main.go soporta multiples modos (audit, explain, tree) (frameworkauditor/main.go, frameworkmecanico/main.go, frameworkmensajero/main.go, frameworkradar/main.go, frameworksabio/main.go, remora/main.go, frameworkradar/main.go)
- **quizzical-murdock-aa8156/.env**: archivo nuevo
- **quizzical-murdock-aa8156/.env.example**: archivo nuevo
- **quizzical-murdock-aa8156/.git**: archivo nuevo
- **quizzical-murdock-aa8156/.gitignore**: archivo nuevo
...
- **frameworkradar/main_test.go**: funciones: TestBuildFollowupResponseIntegratesStructuredEvidenceAndFailure, TestSummarizePortfolioEvidenceUsesStructuredMetricsAndPeers, TestBuildEvidenceCentricFollowupSynthesisUsesVerifiedPortfolioEvidenceFirst, TestRunAnalyzeFollowupPrefersEvidenceFirstSynthesisOverGenericLLMDraft
- **frameworksabio/main_test.go**: funciones: TestRunEntity360ArtifactBuildsStructuredCustomerView, TestSabioQueryArtifactExposesPlainTextAndTrace, TestRunAnalyticalQueryArtifactPortfolioComparison, TestRunAnalyticalQueryArtifactPortfolioComparisonFromFreeTextIntentAndSemanticCapability
- **evento-echo-user-answered**: nuevo evento echo-user-answered (handoff/state.go)
