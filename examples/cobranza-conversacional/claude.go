...
var stubResponses = []string{
	"Hola Patricia, te escribo de FinCrowd. Sé que las cosas a veces se complican y por eso quería contactarte directo, sin presión. Tenemos un saldo pendiente de $847.000 desde hace algunas semanas. ¿Cómo has estado? ¿Hay algo que pueda ayudarte a resolver esto esta semana?",
